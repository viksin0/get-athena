...
- **`downloads/athena-0.2.7.vsix`** — the current packaged extension.
...
1. **Download Athena 0.2.7** — [download the VSIX directly](downloads/athena-0.2.7.vsix), then install it:
  - UI: Extensions view → `···` → **Install from VSIX…**, or
  - Terminal: `code --install-extension athena-0.2.7.vsix`
